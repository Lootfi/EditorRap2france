      ...
      content.blocks.map((block) => {
        ...
        if (block.type == "embed") {
          if (block.data.service == "instagram") {
            const embedInstagram = `<iframe width="${block.data.width}" height="900px" src="${block.data.embed}" frameborder="0"></iframe><p class="text-center mt-2 font-bold">${block.data.caption != null ? block.data.caption : ""}</p>`;
