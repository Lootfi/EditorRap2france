            ...
            <div class="vx-col w-full md:w-3/5 lg:w-3/4 mt-12 md:mt-0">
                <vx-card>
                    ...
                    <div class="article-title mb-6">
                        ...
                        <p class="mt-1">Last updated on <span>{{articleData.updated_at}}</span></p>
                    </div>
  ...
  methods:{
      ...
      JsonFormatter(Data){
        ...
        content.blocks.map((block) => {
            ...
            if(block.type =="quote"){
              rawHtml = `${rawHtml}<div class="my-4"><q>${block.data.text}</q></div>`
            }
             if(block.type =="image"){
